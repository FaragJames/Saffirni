...
const AddBus = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        NumberOfSeats: Yup.number()
            ...
            .positive("*يجب أن يكون عدد المقاعد موجبًا"),
        modelYear: Yup.number()
            .required("*سنة الموديل مطلوبة")
            .min(1900, "*سنة الموديل يجب أن تكون بعد 1900"),
    });
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Field
                                        ...
                                        type="number"
                                        error={
                                            touched.NumberOfSeats &&
                                            Boolean(errors.NumberOfSeats)
                                        }
                                        helperText={
